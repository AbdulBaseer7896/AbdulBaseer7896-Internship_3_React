...
const Cart = () => {
    ...
    const [address , setAdders] = useState('main street , 0012')
      ...
      {cart.products.length > 0 ? 
        <div>
                            ...
                            <div key={product.id} className='flex items-center justify-between p-3 border-b'>
                                ...
                                <div className='flex space-x-12 items-center'>
                                    ...
                                    <div className='flex items-center justify-center border'>
                                        ...
                                        <button onClick={()=>dispatch(increaseQuantity(product.id))} className='text-xl font-bold px-1.5 border-l'>+</button>
                                    </div>
                                    <p>${(product.quantity * product.price).toFixed(2)}</p>
                                    <button className='text-red-500 hover:text-red-700'
                                    onClick={()=>dispatch(removeFromCart(product.id))}><FaTrashAlt/></button>
            ...
            <Model
                ...
                <ChangeAddress setAdders = {setAdders} setIsModelOpen ={setIsModelOpen}/>
            </Model>
        </div>
